...
class Course(Base):
    ...
    start_date = Column(String)  # يمكنك استخدام نوع تاريخ مناسب
...
class DatabaseConnection:
    def __init__(self):
        ...
        Base.metadata.create_all(self.engine)  # إنشاء الجداول إذا لم تكن موجودة
...
class DatabaseBackup:
    ...
    def upload_to_google_drive(self, backup_file):
        try:
            # Authentication and create PyDrive client
            gauth = GoogleAuth()
            gauth.LocalWebserverAuth()  # This opens a web browser for authentication
...
class SchoolManagementSystem:
    ...
    def create_buttons(self):
        buttons = [
            ...
            ("Backup Database", self.backup.backup_database),  # Modified to use the new backup methods
